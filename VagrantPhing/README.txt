...
------------------------------------------
 ...
 2) Download the base box:
    ...
    vagrant box add mybox https://username:password@path/to/vagrant/debian.box
...
Option 2: install your project on your machine
-------------------------------------

You need to have a working LAMP stack with proper configuration.

 1) svn co https://path/to/svn/youtproject/trunk or git pull

 2) Run libstall.sh to download all librairies (composer)

 3) Run phing (build script)

Your project is installed on www/ folder. You will have to configure your
