...
# Install
# profile = standard
drush si -y standard --account-mail=$user_mail --account-name=$user_name --account-pass=$user_pass --site-name=$site_name --site-mail=$user_mail --locale="en" --db-url=mysql://$db_user:$db_pass@$db_host/$db_name;
